  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p onClick={() => navigateToPage('dashboard')}>{"Go to Dashboard >"}</p>
        <p onClick={() => navigateToPage('login')} style={{ cursor: 'pointer', color: '#6366F1', textDecoration: 'underline', marginTop: '1rem' }}>{"Go to Login/Signup >"}</p>
      </main>
    </div>
  );
}
