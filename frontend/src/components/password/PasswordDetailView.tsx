...
import { Eye, EyeOff, Copy, Check, AlertTriangle, ExternalLink, Info, Edit } from "lucide-react";
...
export default function PasswordDetailView({ login }: PasswordDetailViewProps) {
    ...
    const openWebsite = () => {
        const url = login.website || `https://${login.site.toLowerCase()}.com`;
