        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          ...
          >
            <SummaryCard
              ...
              iconColor="bg-gradient-to-br from-red-300 to-red-500 text-red-900"
            />
          </motion.div>
        ...
        <div className="grid grid-cols-12 gap-5 flex-1 min-h-0">
          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-8 flex flex-col">
            {selectedLogin ? (
              ...
              <div className="flex items-center justify-center h-full bg-slate-900 border border-slate-800 rounded-xl p-6">
                <div className="text-center">
                  <div className="rounded-full bg-slate-800 p-4 mx-auto mb-4 w-16 h-16 flex items-center justify-center">
